...
//  Return Value  : None.
//***********************************************************************************************************
void static generateCRC32Table(uint32_t *pTable, uint32_t poly)
{
...
{
    return [self crc32WithSeed:DEFAULT_SEED usingPolynomial:DEFAULT_POLYNOMIAL data:data];
}
...
{
    return [self crc32WithSeed:seed usingPolynomial:DEFAULT_POLYNOMIAL data:data];
}
...
{
    return [self crc32WithSeed:DEFAULT_SEED usingPolynomial:poly data:data];
}
